...
children.push(p("참고(중요도 낮음): 발달재활 제공기관 약 2,160개(2021 실태조사)/1,786개(2024 품질평가 대상, 발달재활 단독). 1인이 여러 기관 출강 → 기관 수 ≠ 고객 수. ※v2 ‘자격 누적 2만~3만’은 과대였고, 활동 제공인력 1.2만~1.3만으로 교체.", { italic: true, color: "667085" }));
children.push(spacer());
