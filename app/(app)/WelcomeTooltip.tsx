...
const TIPS: { emoji: string; title: string; body: React.ReactNode }[] = [
  ...
  { emoji: "👶", title: "내 아동",
    body: <><b>[내 아동]</b> 에 담당 아동을 등록하면 매월 일정표·기록지에서 자동 호출돼요.</> },
  { emoji: "📅", title: "일정표 · 기록지",
    body: <>매월 <b>[일정표]</b> · <b>[기록지]</b> 작성 → 한글파일(.hwpx) 다운로드 → 인쇄·제출. <b>[이번 달]</b> 에서 한 번에 받을 수도 있어요.</> },
  { emoji: "📖", title: "도움말",
    body: <>왼쪽 맨 아래 <b>[도움말]</b> 에서 사용 설명서 + 인앱 투어 다시 보기.</> },
];
