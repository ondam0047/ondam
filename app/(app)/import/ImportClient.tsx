  ...
  return (
    <>
      <div className="section-head">
        <div>
          <h2>엑셀 가져오기</h2>
          <p>쓰던 엑셀을 그대로 올리면 컬럼명을 자동으로 인식해서 내 아동으로 한꺼번에 등록합니다.</p>
        </div>
      </div>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <div className="tip" style={{ marginBottom: 14 }}>
            <span>
              컬럼: <b>성명 · 생년월일 · 시간 · 요일 · 단가 · 본인부담금 · 목표 회기 · 메모</b>{" "}
              (성명 외에는 선택). 채워두면 일정표·기록지에서 아동을 고를 때 자동으로 채워집니다.<br />
              담당 치료사와 서비스 종류는 <b>본인(내 설정 기준)</b>으로 자동 지정돼요.<br />
          ...
          >
            ...
            <div className="sm2">
              쓰던 명단 · 전자바우처 <b>서비스제공내역.xls</b> 모두 가능
            </div>
          </div>
          <input
            ref={fileRef}
          ...
          <div className="table-wrap">
            <table className="table">
              <thead>
                <tr>
                  <th>성명</th><th>생년월일</th>
                  <th>시간</th><th>요일</th><th>단가</th><th>본인부담금</th><th>목표</th>
                </tr>
              </thead>
              <tbody>
                {children.map((c, i) => (
