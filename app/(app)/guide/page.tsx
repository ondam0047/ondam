    ...
    <div className="guide-wrap">
      <div>
        ...
        <Section id="settings" num="2" title="내 설정">
          ...
          <Step n={5} title="수기 기록지 출력 (선택)">
            지자체에 따라 결과를 손으로 적어야 하는 경우 사용. 켜면 한글파일 출력 시 <b>상태 및 결과 기록 / 사유</b>가
            빈칸으로 나오고, 보조 3칸(<b>제공일자·승인일자·승인번호</b>)은 각각 따로 끌 수 있어요.
            나머지 텍스트(이름·시간·바우처·총평 등)는 그대로 인쇄됩니다.
          </Step>
        </Section>
        ...
        <Section id="children" num="3" title="내 아동 등록">
          ...
          <Callout kind="info">
            <b>사업 분기 (발달바우처 / 지투)</b> — 아동마다 <b>발달바우처</b> 또는
            <b> 지역사회서비스투자사업(지투)</b> 을 선택할 수 있어요. 지투의 경우 지자체별 별칭
            (예: <i>우리아이심리지원</i>) 도 함께 입력 가능. 지투 한글파일 양식은 현재 준비 중이라
            등록·일정표 생성·기록 저장은 가능하지만 한글파일 다운로드는 양식이 추가되면 활성화됩니다.
          </Callout>
        </Section>
