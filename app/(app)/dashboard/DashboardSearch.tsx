...
const TARGETS: Target[] = [
  { label: "이번 달", href: "/month", desc: "이 달 일정·기록지 현황·일괄 받기", kw: ["마감", "다운로드", "zip", "이번달", "월", "현황"] },
  { label: "일정표", href: "/schedule", desc: "회기 일정 생성·출력", kw: ["일정", "회기", "캘린더", "스케줄", "달력"] },
  { label: "월간 보기", href: "/timetable", desc: "저장된 일정 월간 달력", kw: ["시간표", "월간", "달력"] },
  { label: "기록지", href: "/record", desc: "회기 기록·결과 작성·출력", kw: ["일지", "결과", "기록", "작성"] },
  { label: "내 아동", href: "/children", desc: "아동 등록·기본값", kw: ["아동", "학생", "등록", "명단", "엑셀"] },
  { label: "결제 겹침 찾기", href: "/approval-check", desc: "결제 시간 겹침·소급 점검", kw: ["승인", "결제", "겹침", "점검", "바우처", "소급", "내역"] },
  { label: "바로툴", href: "/tools", desc: "음성·말 모듈", kw: ["음성", "mpt", "daf", "스펙트로그램", "유창성", "말속도", "음도", "강도", "도구"] },
  { label: "우리 센터 양식", href: "/forms", desc: "센터 기록지·일정표 업로드·매핑", kw: ["양식", "매핑", "hwpx", "업로드", "서식", "센터"] },
  { label: "기타지원사업", href: "/support", desc: "교육청 치료지원(마음모아) 일지", kw: ["마음모아", "교육청", "치료지원", "지원사업", "운영"] },
  { label: "내 설정", href: "/center", desc: "센터·단가·시간대·내 정보", kw: ["설정", "센터", "단가", "시간대", "프로필", "이름"] },
