...
export async function GET() {
  ...
  const ws_data: (string | number)[][] = [
    ["성명", "생년월일", "관리번호", "서비스", "담당", "시간", "요일", "단가", "본인부담금", "목표 회기", "메모"],
    ["김바로", "19.04.02", "240012345", exampleService1, "이언어", "10:00-10:50", "월, 수", 65000, 40000, 5, ""],
    ["강일지", "20.09.07", "240067890", exampleService2, "김놀이", "13:30-14:20", "목, 금", 65000, 40000, 5, ""],
    // 같은 김바로가 다른 서비스를 받는 예 — 같은 사람으로 자동 묶임 (name+birth 일치)
    ["김바로", "19.04.02", "", exampleService2, "김놀이", "14:20-15:10", "수", 65000, 40000, 4, "같은 아동의 두 번째 서비스"],
  ];

  const ws = XLSX.utils.aoa_to_sheet(ws_data);
  ws["!cols"] = [
    { wch: 10 }, { wch: 12 }, { wch: 13 }, { wch: 14 }, { wch: 10 }, { wch: 14 },
