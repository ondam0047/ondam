...
// 1인 사물함 — 서비스 종류·담당 치료사는 본인 설정으로 자동 지정되므로 양식엔 없음.
...
export async function GET() {
  ...
  const ws_data: (string | number)[][] = [
    ["성명", "생년월일", "시간", "요일", "단가", "본인부담금", "목표 회기", "메모"],
    ["김바로", "19.04.02", "10:00-10:50", "월, 수", 65000, 40000, 5, ""],
    ["강일지", "20.09.07", "13:30-14:20", "목, 금", 65000, 40000, 5, ""],
  ];

  const ws = XLSX.utils.aoa_to_sheet(ws_data);
  ws["!cols"] = [
    { wch: 10 }, { wch: 12 }, { wch: 14 }, { wch: 10 },
    { wch: 10 }, { wch: 11 }, { wch: 10 }, { wch: 18 },
  ];
