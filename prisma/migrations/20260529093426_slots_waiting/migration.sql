...
INSERT INTO "new_Center" ("address", "approvalCode", "createdAt", "id", "name", "phone", "serviceTypes", "updatedAt") SELECT "address", "approvalCode", "createdAt", "id", "name", "phone", "serviceTypes", "updatedAt" FROM "Center";
DROP TABLE "Center";
