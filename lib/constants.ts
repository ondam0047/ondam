...
// 일괄 생성에서 저장 못 한 아동 '이름'만 잠깐(30초) 실어 나르는 쿠키.
// 이름을 URL 쿼리에 넣으면 nginx 접근로그·브라우저 방문기록에 그대로 남는다 —
// 이 앱은 URL 에 아동 ID 만 쓰고 이름은 넣지 않는 규율을 지킨다(?cs=<id>).
export const BULK_FAIL_COOKIE = "baroilji_bulk_fail";
...
export const HOLIDAYS: Record<string, string> = {
  ...
  "2027-2-7": "설날",
  "2027-2-8": "설날연휴",
  "2027-2-9": "대체공휴일", // 설날(2/7)이 일요일 → 대체
  "2027-3-1": "삼일절",
  "2027-5-5": "어린이날",
  "2027-5-13": "부처님오신날",
  "2027-6-6": "현충일",
  ...
  "2027-10-11": "대체공휴일",
  "2027-12-25": "성탄절",
  "2027-12-27": "대체공휴일", // 성탄절(12/25)이 토요일 → 대체
  // 2028
  "2028-1-1": "신정",
  "2028-1-26": "설날연휴",
  "2028-1-27": "설날",
